...
//				
//				if( student == null ) {
//					JOptionPane.showMessageDialog(view, "Aucun �tudiant n'est s�lectionn� !", "Attention", JOptionPane.WARNING_MESSAGE);
//					return;
//				}
//				
//				int option = JOptionPane.showConfirmDialog( view, 
//								"Voulez-vous vraiment supprimer l'�tudiant(e) "+student.getFirstName()+" "+student.getName()+" ?", "Confirmation", 
	...
	private void handleEventsOnSubjects() {
		...
		commands.put( EVT_REMOVE_SUBJECT, new Procedure<Arg1<ActionEvent>>() {
			...
			public void invoke(Arg1 <ActionEvent> arguments ) {
				...
				if( subject == null ) {
					JOptionPane.showMessageDialog(view, "Aucun sujet n'est s�lectionn� !", "Attention", JOptionPane.WARNING_MESSAGE);
					return;
				}
	...
	private void handleEventsOnProjects() {
		...
		commands.put( EVT_REMOVE_PROJECT, new Procedure<Arg1<ActionEvent>>() {
			...
			public void invoke(Arg1 <ActionEvent> arguments ) {
				...
				if( project == null ) {
					JOptionPane.showMessageDialog(view, "Aucun projet n'est s�lectionn� !", "Attention", JOptionPane.WARNING_MESSAGE);
					return;
				}
	...
	private void handleEventsOnStakeholders() {
		...
		commands.put( EVT_REMOVE_STAKEHOLDER, new Procedure<Arg1<ActionEvent>>() {
			...
			public void invoke(Arg1 <ActionEvent> arguments ) {
				...
				if( stakeholder == null ) {
					JOptionPane.showMessageDialog(view, "Aucun(e) intervenant(e) n'est s�lectionn�(e) !", "Attention", JOptionPane.WARNING_MESSAGE);
					return;
				}
			...
			public void invoke(Arg1<ActionEvent> arguments) {
				...
				try {
					...
					JOptionPane.showMessageDialog( view,
							   "Fichier sauvegard� avec succ�s.", "Success !",
