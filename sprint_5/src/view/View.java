...
public class View extends JFrame implements Constants {
	...
	private JTabbedPane createTabbedArea() {
		...
		panHelp = new JPanel();
		JLabel aide = new JLabel("En cas de difficult�s, contacter Emmanuel Chebbi, le g�nialissime chef de projet � cette adresse : emmanuel.chebbi@etu.univ-tlse2.fr");
		panHelp.add(aide);
