...
public class JPanelStakeholder extends JPanel implements Constants {
	...
	public JPanelStakeholder(Controller controller, JFrame frame) {
		...
		sortAffected = new JCheckBox("Non-affect�s");
		...
		detailsProject = new JButton("D�tails du projet");
		...
		eastSide.setBorder(BorderFactory.createTitledBorder("D�tail de l'intervenant"));
