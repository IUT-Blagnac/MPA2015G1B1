...
:haveJava
"%JAVA_HOME%\bin\java" -classpath ".\tools\aspectj1.7\lib\aspectjtools.jar;%JAVA_HOME%\lib\tools.jar;%CLASSPATH%" -Xmx64M org.aspectj.tools.ajc.Main %1 %2 %3 %4 %5 %6 %7 %8 %9
